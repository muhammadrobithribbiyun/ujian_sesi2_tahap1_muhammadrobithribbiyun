                     ...
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <select class="form-control" name="level">
                              ...
                              <option <?php if($p->pengguna_level == "dokter"){ echo "selected='selected'";} ?> value="dokter">Dokter</option>
                              <option
                                 <?php if($p->pengguna_level == "pegawai"){ echo "selected='selected'";} ?> value="pegawai">Pegawai</option>
                              <option
                                 <?php if($p->pengguna_level == "pasien"){ echo "selected='selected'";} ?> value="pasien">pasien</option>
                           </select>
